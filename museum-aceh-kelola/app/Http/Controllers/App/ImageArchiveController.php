...
class ImageArchiveController extends Controller
{
    ...
    public function data(Request $request, Collection $collection)
    {
        ...
        $list_collection = ImageArchive::where($where)->search($search);
    ...
    {
        return view('app.image_archive.index', compact('collection'));
    }
    ...
    {
        return view('app.image_archive.form', compact('collection'));
    }
    ...
    public function store(Request $request, Collection $collection)
    {
        ...
        $filename = 'uploads/image_archive/'. md5(rand(0, 9999)). '.'. $file->getClientOriginalExtension();
        ...
        return redirect()->route('app.collection.image_archive.index', $collection->id);
    }
