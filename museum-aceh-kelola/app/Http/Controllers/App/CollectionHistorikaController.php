...
class CollectionHistorikaController extends Controller
{
    ...
    {
        $collection_historika = CollectionHistorika::create([
        ...
        $collection = Collection::create([
            ...
            'collectionable_type' => CollectionHistorika::class,
            'collectionable_id' => $collection_historika->id,
        ]);

        return redirect()->route('app.collection_historika.edit', $collection_historika->id);
    }
    ...
    {
        return view('app.collection_historika.form', compact('collection_historika'));
    }
    ...
    public function update(Request $request, CollectionHistorika $collection_historika)
    {
        ...
        $collection_historika->collection->update([
            'nama' => $request->get('nama'),
            'nomor_inventaris' => $request->get('nomor_inventaris'),
            'tanggal_inventaris' => $request->get('tanggal_inventaris'),
            'tanggal_pengadaan' => $request->get('tanggal_pengadaan'),
