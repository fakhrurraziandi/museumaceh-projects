...
class CollectionNumismatikaController extends Controller
{
    ...
    {
        $collection_numismatika = CollectionNumismatika::create([
        ...
        $collection = Collection::create([
            ...
            'collectionable_type' => CollectionNumismatika::class,
            'collectionable_id' => $collection_numismatika->id,
        ]);

        return redirect()->route('app.collection_numismatika.edit', $collection_numismatika->id);
    }
    ...
    {
        return view('app.collection_numismatika.form', compact('collection_numismatika'));
    }
    ...
    public function update(Request $request, CollectionNumismatika $collection_numismatika)
    {
        ...
        $collection_numismatika->collection->update([
            'nama' => $request->get('nama'),
            'nomor_inventaris' => $request->get('nomor_inventaris'),
            'tanggal_inventaris' => $request->get('tanggal_inventaris'),
            'tanggal_pengadaan' => $request->get('tanggal_pengadaan'),
