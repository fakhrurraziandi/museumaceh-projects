...
class CollectionTeknologikaController extends Controller
{
    ...
    {
        $collection_teknologika = CollectionTeknologika::create([
        ...
        $collection = Collection::create([
            ...
            'collectionable_type' => CollectionTeknologika::class,
            'collectionable_id' => $collection_teknologika->id,
        ]);

        return redirect()->route('app.collection_teknologika.edit', $collection_teknologika->id);
    }
    ...
    {
        return view('app.collection_teknologika.form', compact('collection_teknologika'));
    }
    ...
    public function update(Request $request, CollectionTeknologika $collection_teknologika)
    {
        ...
        $collection_teknologika->collection->update([
            'nama' => $request->get('nama'),
            'nomor_inventaris' => $request->get('nomor_inventaris'),
            'tanggal_inventaris' => $request->get('tanggal_inventaris'),
            'tanggal_pengadaan' => $request->get('tanggal_pengadaan'),
