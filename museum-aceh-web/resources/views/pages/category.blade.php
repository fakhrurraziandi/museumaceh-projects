    ...
    <div class="container">
        <div class="row py-4 align-items-center">
            <div class="col-sm-12">
                ...
                <h2 class=" mb-4" style="text-transform: uppercase;">Berita <small style="text-transform: capitalize; font-size: 1.2rem;"> <span class="text-primary">{{$category->name}}</span></small></h2>
