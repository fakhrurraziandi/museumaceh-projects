...
class CreateCollectionHistorikaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('collection_historika', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('collection_historika');
    }
}
