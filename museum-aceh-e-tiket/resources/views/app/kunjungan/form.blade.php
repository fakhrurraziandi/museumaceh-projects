                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    ...
                                    <div class="form-group row" id="row-jumlah" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <small class="text-success label-success-tarif-rombongan" style="display: none;" >Berlaku Tarif Rombongan</small>
                                        </div>
                                    </div>
    ...
    <script>
        $(function(){
            ...
            function onFormChangeHandler(){
                ...
                console.log(tarif_individu, tarif_rombongan, jumlah);

                var tarif = 0;

                if(enable_rombongan && jumlah > 10){
                    // Berlaku Tarif Rombongan
                    tarif = tarif_rombongan;
                    $('.label-success-tarif-rombongan').show();
                }else{
                    tarif = tarif_individu;
                    $('.label-success-tarif-rombongan').hide();
                }
                // tarif = tarif_individu;
