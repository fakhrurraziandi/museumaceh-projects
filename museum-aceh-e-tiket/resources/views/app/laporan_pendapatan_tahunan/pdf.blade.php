...
<p style="font-size: 80%; text-indent: 50px;">Dengan ini kami sampaikan data laporan pendapatan UPTD Museum Aceh Selama {{$tahun}}, yang di unduh dari aplikasi e-ticket Museum Aceh.</p>
    ...
    <thead>
        <tr>
            ...
            @foreach($list_kategori_pengunjung as $kategori_pengunjung)
                ...
                @endif
            @endforeach
            <th style="width: 100px;">Pendapatan/Bulan</th>
        </tr>
    </thead>
            ...
            <tr>
                ...
                @foreach($list_kategori_pengunjung as $kategori_pengunjung)
                    <td>
                        ...
                        echo $result[0]->jumlah_pendapatan ? 'Rp. '. number_format($result[0]->jumlah_pendapatan, 0, ',', '.') : '-';
                        ?>
                    </td>
                    @if($kategori_pengunjung->enable_rombongan)
                        <td>
...
<p style="font-size: 80%; text-indent: 50px;">Laporan pendapatan UPTD Museum Aceh ini adalah laporan resmi berdasarkan data pendapatan selama tahun {{$tahun}}. Demikian laporan ini kami sampaikan, agar dapat digunakan sesuai dengan kebutuhan. Terima kasih.   </p>
