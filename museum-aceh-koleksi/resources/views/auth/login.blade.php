                    ...
                    <div class="card-body pb-3" style="padding-left: 70px; padding-right: 70px; position: relative;">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="Email address">
                                @error('email')
