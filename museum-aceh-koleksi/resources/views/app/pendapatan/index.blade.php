            ...
            <div class="col-sm-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header">
                        Table Jumlah Pendapatan - Tahun {{$selected_tahun }}
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        @foreach(KategoriPengunjung::all() as $kategori_pengunjung)
                                            <td>
                                                ...
                                                ->whereYear('created_at', '=', $selected_tahun)->sum('total_pembayaran');
                                                $sub_total += $jumlah_individu;
                                                echo 'Rp. ' . number_format($jumlah_individu, 0, ',', '.');
                                                ?>
                                            </td>
                                            @if($kategori_pengunjung->enable_rombongan)
                                                <td>
                                                    ...
                                                    echo 'Rp. ' . number_format($jumlah_rombongan, 0, ',', '.');
                                                    ?>
                                                </td>
                                            @endif
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    @foreach(KategoriPengunjung::all() as $kategori_pengunjung)
                                        <th>
                                            ...
                                            echo 'Rp. '. number_format($total_individu, 0, ',', '.');
                                            ?>
                                        </th>
                                        @if($kategori_pengunjung->enable_rombongan)
                                            <th>
                                                ...
                                                echo 'Rp. '. number_format($total_rombongan, 0, ',', '.');
                                                ?>
                                            </th>
                                        @endif
                                    @endforeach
                                    <th>
                                        <?php 
                                        $grand_total = (int) Kunjungan::whereYear('created_at', '=', $selected_tahun)->sum('total_pembayaran');
