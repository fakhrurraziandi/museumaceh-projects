                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            <a href="{{route('app.collection.image_archive.create', $collection->id)}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '{{route('app.collection.image_archive.data', $collection->id)}}',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
